			...
			<div class="col-lg-12">
				<div class="logo__carousel owl-carousel">
					<div class="logo__carousel__item">
						<a href="#"><img src="<?php echo base_url('assets/img/logo/logo-1.png'); ?>" alt=""></a>
					</div>
					<div class="logo__carousel__item">
						<a href="#"><img src="<?php echo base_url('assets/img/logo/logo-2.png'); ?>" alt=""></a>
					</div>
					<div class="logo__carousel__item">
						<a href="#"><img src="<?php echo base_url('assets/img/logo/logo-3.png'); ?>" alt=""></a>
					</div>
					<div class="logo__carousel__item">
						<a href="#"><img src="<?php echo base_url('assets/img/logo/logo-4.png'); ?>" alt=""></a>
					</div>
					<div class="logo__carousel__item">
						<a href="#"><img src="<?php echo base_url('assets/img/logo/logo-5.png'); ?>" alt=""></a>
					</div>
				</div>
			</div>
		</div>
