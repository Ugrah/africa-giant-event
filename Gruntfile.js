module.exports = function(grunt) {
    ...
    let gruntConfig = {
        ...
        uglify: {
            my_target: {
                files: {
                    ...
                    'assets/themes/africa_giant_event/js/clients.min.js': ['assets/themes/africa_giant_event/js/clients.js'],
                    'assets/themes/africa_giant_event/js/global.min.js': ['assets/themes/africa_giant_event/js/global.js'],
        ...
        cssmin: {
            target: {
                files: [{
                        src: ['assets/themes/africa_giant_event/css/style.css'],
                        dest: 'assets/themes/africa_giant_event/css/style.min.css',
                        ext: '.min.css'
                    },
                    {
        ...
        postcss: {
            ...
            dist: {
                src: [
                    'assets/css/*.css',
                    '!assets/css/*.min.css',
                    'assets/themes/africa_giant_event/css/*.css',
                    '!assets/themes/africa_giant_event/css/*.min.css',
                ]
            }
        },
        concat: {
        ...
        header: {
            dist: {
                ...
                files: {
                    ...
                    'assets/themes/africa_giant_event/js/clients.min.js': 'assets/themes/africa_giant_event/js/clients.min.js',
                    'assets/themes/africa_giant_event/js/global.min.js': 'assets/themes/africa_giant_event/js/global.min.js',
                }
            }
        },
    }
